...
uint8_t mx_h,mx_l,my_h,my_l, mz_h,mz_l;   //Magnetometro
...
void loop() {
  ...
  if ((mpuIntStatus & 0x10) || fifoCount == 1024) {
    ...
    mag.getHeading(&mx_h, &my_h, &mz_h,&mx_l, &my_l, &mz_l);
...
void mostraFIFO(){
  //QUAT W
  Serial.print(fifoBuffer[0]);  Serial.print("\t"); 
  Serial.print(fifoBuffer[1]);  Serial.print("\t"); 
  //QUAT X
  Serial.print(fifoBuffer[4]); Serial.print("\t"); 
  Serial.print(fifoBuffer[5]); Serial.print("\t"); 
  //QUAT Y
  Serial.print(fifoBuffer[8]); Serial.print("\t"); 
  Serial.print(fifoBuffer[9]); Serial.print("\t"); 
  //QUAT Z
  Serial.print(fifoBuffer[12]); Serial.print("\t"); 
  Serial.print(fifoBuffer[13]); Serial.print("\t"); 
  //GYRO X
  Serial.print(fifoBuffer[16]); Serial.print("\t"); 
  Serial.print(fifoBuffer[17]); Serial.print("\t"); 
  //GYRO Y
  Serial.print(fifoBuffer[20]); Serial.print("\t"); 
  Serial.print(fifoBuffer[21]); Serial.print("\t"); 
  //GYRO Z
  Serial.print(fifoBuffer[24]); Serial.print("\t"); 
  Serial.print(fifoBuffer[25]); Serial.print("\t"); 
  //ACC X
  Serial.print(fifoBuffer[28]); Serial.print("\t"); 
  Serial.print(fifoBuffer[29]); Serial.print("\t"); 
  //ACC Y
  Serial.print(fifoBuffer[32]); Serial.print("\t"); 
  Serial.print(fifoBuffer[33]); Serial.print("\t"); 
  //ACC Z
  Serial.print(fifoBuffer[36]); Serial.print("\t"); 
  Serial.print(fifoBuffer[37]); Serial.print("\t"); 
  //MAG X
  Serial.print(mx_h); Serial.print("\t"); 
  Serial.print(mx_l); Serial.print("\t"); 
  //MAG Y
  Serial.print(my_h); Serial.print("\t"); 
  Serial.print(my_l); Serial.print("\t"); 
  //MAG Z
  Serial.print(mz_h); Serial.print("\t"); 
  Serial.print(mz_l); Serial.print("\n"); 
