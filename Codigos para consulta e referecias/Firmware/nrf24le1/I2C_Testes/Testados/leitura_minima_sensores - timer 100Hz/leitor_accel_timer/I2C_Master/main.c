/* Explicação:
    Leitor:
    Ao se clicar no botão 1 - a configura��o da mpu � feita
    Ao se clicar no botão 2 - � realizada a leitura e envio
	...
	Interpreta atraves de Start, size e End, ent�o mostra Xac, Yac e Zac
*/
/***********************************************/
