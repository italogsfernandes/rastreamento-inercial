...
uint8_t const ADDR_SENSOR[NRO_SENSOR] = {0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A}; // Define the sensors address
...
void rfInit(void)
{
  ...
  SPI_RW_Reg(WRITE_REG + RF_CH, 90);        	// Select RF channel 90. Fo = 2,490 GHz
