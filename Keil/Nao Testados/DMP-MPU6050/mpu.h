//Todas as funções aqui estão identicas às encontradas no "funcionsDMP".
//So copiei, colei, e coloquei algumas definições antes do include
//FIXME: Favor olhar a declaração de variaveis aqui dentro, se nao vai dar erro
...
//FIXME: Funciona essas inicializações de variaveis dentro da biblioteca?
