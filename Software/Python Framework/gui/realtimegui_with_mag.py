...
class Main(QMainWindow, Ui_MainWindow):
	...
	def rotate_joints_from_data_vector(self, data):
		...
		self.plot()
		joint = self.skeleton.getJoint(BodyJoints.UNILAT, BodyJoints.TORSO)
		print 'TORSO AFTER ROTATION:', joint.quaternion
	...
	def updateSensorOffsets(self):
		arqGyro = open("gyroOffsets.txt", 'r')
