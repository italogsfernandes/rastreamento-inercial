...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnSentado = QtGui.QPushButton(self.groupBox)
        self.btnSentado.setGeometry(QtCore.QRect(0, 300, 101, 28))
        self.btnSentado.setObjectName(_fromUtf8("btnSentado"))
        self.btnSavePostura = QtGui.QPushButton(self.groupBox)
        self.btnSavePostura.setGeometry(QtCore.QRect(0, 330, 101, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnMarcar.setText(_translate("MainWindow", "Marcar Posicao de Repouso", None))
        ...
        self.btnSentado.setText(_translate("MainWindow", "Sentado", None))
