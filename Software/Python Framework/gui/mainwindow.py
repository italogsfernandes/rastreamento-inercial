...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnColeta = QtGui.QPushButton(self.groupBox)
        self.btnColeta.setObjectName(_fromUtf8("btnColeta"))
        self.verticalLayout.addWidget(self.btnColeta)
        self.btnMarcar = QtGui.QPushButton(self.groupBox)
        self.btnMarcar.setObjectName(_fromUtf8("btnMarcar"))
        self.verticalLayout.addWidget(self.btnMarcar)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Opções:", None))
